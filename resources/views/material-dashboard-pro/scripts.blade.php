...
<script src="{{asset('material-dashboard/assets/js/core/bootstrap-material-design.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('material-dashboard/assets/js/')}}"></script> --}}
