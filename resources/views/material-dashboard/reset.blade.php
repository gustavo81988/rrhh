        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
              ...
              <div class="card card-login card-hidden">
                <div class="card-header card-header-rose text-center" style="padding: 30px">
                  <h4 class="card-title"><img src="{{asset('svg/overall_white.svg')}}" alt=""></h4>
                ...
                <div class="card-footer justify-content-center">
                  <button href="#pablo" type="submit" class="btn btn-rose btn-link btn-lg">Enviar</button>
                </div>
              </div>
            </form>
          </div>
